...
To limit the amount of data held in memory, a certain number of contigs are processed at a time. This is currently set to three but can be changed in the code:
...
################### run the function to process contigs ######################
